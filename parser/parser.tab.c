...
yyreduce:
  ...
  case 2: /* expr: NUMBER  */
#line 31 "parser.y"
                      { (yyval.intval) = (yyvsp[0].intval); parsing_result = (yyval.intval); }
#line 1074 "parser.tab.c"
    break;

  case 3: /* expr: expr '+' expr  */
#line 32 "parser.y"
                      { (yyval.intval) = (yyvsp[-2].intval) + (yyvsp[0].intval); parsing_result = (yyval.intval); }
...
#line 1105 "parser.tab.c"
  ...
  case 7: /* expr: '(' expr ')'  */
#line 43 "parser.y"
                      { (yyval.intval) = (yyvsp[-1].intval); parsing_result = (yyval.intval); }
